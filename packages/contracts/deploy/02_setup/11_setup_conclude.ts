...
import {ValidHashConditionSetup__factory, ValidHashCondition__factory} from '../../typechain';
...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  const setup = ValidHashConditionSetup__factory.connect(
    setupDeployment.address,
    deployer
  );
  const implementation = ValidHashCondition__factory.connect(
